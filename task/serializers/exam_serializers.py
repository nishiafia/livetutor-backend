...
class ExamSubmissionSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        ExamSubmissionFile.objects.bulk_create([ExamSubmissionFile(file=assignment_submission_file['file']
            ,exam_submission=exam_submission) for assignment_submission_file in exam_submission_files])
